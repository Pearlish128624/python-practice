...
def test_rank():
    """Test the rank functionality"""
    print("Testing rank functionality...")
    
    # Test 1: Add a new score
    print("\nTest 1: Adding new score...")
    update_rank("TestPlayer1", 5)
    display_rank()
    
    # Test 2: Add a higher score for same player
    print("\nTest 2: Adding higher score for same player...")
    update_rank("TestPlayer1", 8)
    display_rank()
    
    # Test 3: Add a lower score for same player (shouldn't update)
    print("\nTest 3: Adding lower score for same player...")
    update_rank("TestPlayer1", 3)
    display_rank()
    
    # Test 4: Add multiple players
    print("\nTest 4: Adding multiple players...")
    update_rank("TestPlayer2", 6)
    update_rank("TestPlayer3", 10)
    display_rank()
